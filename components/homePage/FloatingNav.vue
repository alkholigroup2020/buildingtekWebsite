    ...
    >
      ...
      <div class="d-flex flex-column justify-center">
        <v-btn class="mt-8" :ripple="false" text color="transparent">
          ...
          >
            <a
              @click="goToSection('#landing', 1), (drawer = false)"
        ...
        <v-btn class="mt-8" :ripple="false" text color="transparent">
          ...
          >
            <a
              @click="goToSection('#servicesSection', 1), (drawer = false)"
              class="text-decoration-none"
              :style="
                $i18n.locale == 'en'
                  ? 'font-family: Montserrat!important'
        ...
        <v-btn class="mt-8" :ripple="false" text color="transparent">
          ...
          >
            <a
              @click="goToSection('#portfolio', 1), (drawer = false)"
              class="text-decoration-none"
              :style="
                $i18n.locale == 'en'
                  ? 'font-family: Montserrat!important'
